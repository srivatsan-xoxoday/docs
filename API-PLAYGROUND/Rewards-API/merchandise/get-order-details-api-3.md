...
slug: "get-order-details-api-3"
excerpt: "With the help of this endpoint you can fetch the order details of a specific order"
hidden: false
createdAt: "Thu May 15 2025 08:17:30 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Sat Nov 22 2025 22:23:31 GMT+0000 (Coordinated Universal Time)"
openapi: "API-PLAYGROUND/Rewards-API/merchandise/spec.yaml POST /getOrderDetails"
---
## Request Schema
...
1. We do not recommend calling GetOrderDetails API to poll the order status for delayed delivery orders. Instead, implement [Webhooks](https://helpcenter.xoxoday.com/reference/how-to-implement-webhooks) to be notified when an order status is changed
