...
slug: "get-filter-api-2"
excerpt: "Filters API allows you to identify filters that are available which can be applied to filter the products in Get Voucher API"
hidden: false
createdAt: "Thu Aug 21 2025 12:32:09 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Sat Nov 22 2025 21:01:39 GMT+0000 (Coordinated Universal Time)"
openapi: "API-PLAYGROUND/Rewards-API/mobile-top-up-api/spec.yaml POST /getFilters"  
---
## Note:
...
| topup            | Users can filter products based on mobile/DTH/data recharge or top-up plans                |
